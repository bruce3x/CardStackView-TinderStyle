...
![Overview](./images/sample-overview.gif)
...
![ManualSwipe](./images/sample-manual-swipe.gif)

## Automatic Swipe

![AutomaticSwipe](./images/sample-automatic-swipe.gif)
...
![Cancel](./images/sample-cancel.gif)

## Rewind

![Rewind](./images/sample-rewind.gif)
...
| Value | Sample |
| :----: | :----: |
| Left | ![Overlay-Left](./images/sample-overlay-left.png) |
| Right | ![Overlay-Right](./images/sample-overlay-right.png) |
...
| :----: | :----: | :----: |
| ✅ | None | ![StackFrom-None](./images/sample-stack-from-none.png) |
|  | Top | ![StackFrom-Top](./images/sample-stack-from-top.png) |
| | Bottom | ![StackFrom-Bottom](./images/sample-stack-from-bottom.png) |
| | Left | ![StackFrom-Left](./images/sample-stack-from-left.png) |
| | Right | ![StackFrom-Right](./images/sample-stack-from-right.png) |
...
| Default | Value | Sample |
| :----: | :----: | :----: |
| | 2 | ![VisibleCount-2](./images/sample-visible-count-2.png) |
| ✅ | 3 | ![VisibleCount-3](./images/sample-visible-count-3.png) |
| | 4 | ![VisibleCount-4](./images/sample-visible-count-4.png) |
...
| Default | Value | Sample |
| :----: | :----: | :----: |
| | 4dp | ![TranslationInterval-4dp](./images/sample-translation-interval-4dp.png) |
| ✅ | 8dp | ![TranslationInterval-8dp](./images/sample-translation-interval-8dp.png) |
| | 12dp | ![TranslationInterval-12dp](./images/sample-translation-interval-12dp.png) |
...
| Default | Value | Sample |
| :----: | :----: | :----: |
| ✅ | 95% | ![ScaleInterval-95%](./images/sample-scale-interval-95.png) |
| | 90% | ![ScaleInterval-90%](./images/sample-scale-interval-90.png) |
...
| Default | Value | Sample |
| :----: | :----: | :----: |
| ✅ | 20° | ![MaxDegree-20](./images/sample-max-degree-20.png) |
| | 0° | ![MaxDegree-0](./images/sample-max-degree-0.png) |
...
| Default | Value | Sample |
| :----: | :----: | :----: |
| ✅ | Horizontal | ![SwipeDirection-Horizontal](./images/sample-swipe-direction-horizontal.gif) |
| | Vertical | ![SwipeDirection-Vertical](./images/sample-swipe-direction-vertical.gif) |
| | Freedom | ![SwipeDirection-Freedom](./images/sample-swipe-direction-freedom.gif) |
...
| Default | Value | Sample |
| :----: | :----: | :----: |
| ✅ | 30% | ![SwipeThreshold-30%](./images/sample-swipe-threshold-30.gif) |
| | 10% | ![SwipeThreshold-10%](./images/sample-swipe-threshold-10.gif) |
...
| :----: | :----: | :----: |
| true | true | ![SwipeRestriction-NoRestriction](./images/sample-swipe-restriction-no-restriction.gif) |
| true | false | ![SwipeRestriction-CanScrollHorizontalOnly](./images/sample-swipe-restriction-can-scroll-horizontal-only.gif) |
| false | true | ![SwipeRestriction-CanScrollVerticalOnly](./images/sample-swipe-restriction-can-scroll-vertical-only.gif) |
| false | false | ![SwipeRestriction-CannotSwipe](./images/sample-swipe-restriction-cannot-swipe.gif) |
